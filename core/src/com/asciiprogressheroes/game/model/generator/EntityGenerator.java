...
public class EntityGenerator {
    ...
    public static Enemy newEnemy(int level, RegionName region) {
        int index = rand.nextInt(region.enemyNames.length);
        Enemy enemy = new Enemy(newBasicEnemyWeapon(), region.enemyNames[index]);
